#pragma ident "$Id: CRC32.cpp 3140 2012-06-18 15:03:02Z susancummins $"
...
namespace vdraw
{
  const unsigned int CRC32::crc_table[256] =
  {
  ...
  void CRC32::update(const char* buf, unsigned int len)
  {
