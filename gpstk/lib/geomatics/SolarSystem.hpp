#pragma ident "$Id: SolarSystem.hpp 3151 2012-06-20 20:08:46Z snelsen $"
...
namespace gpstk {
//------------------------------------------------------------------------------------
/// Class SolarSystem encapsulates the information in the JPL ephemeris file, both
...
/// instantiates a SolarSystem object, calls initializeWithBinaryFile(file) once,
/// passing it the name of the binary file, then calling computeState() any number
/// of times, passing it the time and Planet of interest.
class SolarSystem{
public:
   ...
   /// read yet.
   SolarSystem(void) throw() : EphemerisNumber(-1) {};
   ...
   /// @return Position of the planet relative to Earth center.
