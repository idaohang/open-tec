#pragma ident "$Id: mdptool.cpp 3140 2012-06-18 15:03:02Z susancummins $"
...
public:
   MDPTool(const std::string& applName)
      ...
      : timeFormat("%4Y %3j %02H:%02M:%04.1f"),
        ...
        styleOpt(
           ...
           "MDP stream. Valid styles are: brief, verbose, table, header, csv, track, "
   ...
   bool initialize(int argc, char *argv[]) throw()
   {
      ...
      if (style == "brief")
         ...
         processor = new MDPHeaderProcessor(mdpInput, output);
      else if (style == "csv")
